...
namespace Engine
{
	inline EMU_API std::shared_ptr<IPhysicsBody> CreatePhysicsBody(const BodyType bodyType, const bool fixed, const float startingXInMeters, const float startingYInMeters,
