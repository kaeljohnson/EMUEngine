...
#if defined(DEBUG)
#define ENGINE_LOG_D(...)    ::Engine::GlobalLogger->EngineTrace(__VA_ARGS__)
...
#define CLIENT_LOG_D(...)    ::Engine::GlobalLogger->ClientTrace(__VA_ARGS__)
...
#define ENGINE_LOG(...) ::Engine::GlobalLogger->EngineTrace(__VA_ARGS__)
...
#define CLIENT_LOG(...) ::Engine::GlobalLogger->ClientTrace(__VA_ARGS__)
